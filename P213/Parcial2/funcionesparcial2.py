...
def modificar_personaje(datos: list) -> list:
    ...
    for i in range(len(datos)):
        if datos[i]["nombre"] == nombre:
            ...
            if caracteristica == "nombre" or caracteristica == "raza" or caracteristica == "planeta" or caracteristica == "alineacion" or caracteristica == "transformaciones" or caracteristica == "tecnicas":
